...
app = Flask(__name__)
"""
    Here we use this function to take the new Sentence to predict it's catogeries
...
"""
    ...
    1- load the database file for the cleaned dataset Usinf create_engine method 
    from sqlalchemy Library and then read the sql file.
    2-Load the model Trained.
